...
public class AoTDSopMemFlags {
    public static String FIRST_COLONY_TIMELINE_FLAG = "$aotd_sop_first_colonization";
    public static String GATE_ARRIVAL_WITNESS = "$aotd_sop_gate_arrival_witness";
