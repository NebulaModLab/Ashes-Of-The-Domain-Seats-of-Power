...
public class ExploratoriaAssignmentAI extends RouteFleetAssignmentAI {
//Based on HMI , thanks to mod author for allowing of usage of HMIScavengerClasses
	...
	public ExploratoriaAssignmentAI(CampaignFleetAPI fleet, RouteData route, boolean pirate) {
		super(fleet, route);
		this.pirate = pirate;
	}
